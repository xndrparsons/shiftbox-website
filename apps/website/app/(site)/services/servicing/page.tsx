        ...
        <section className="bg-white dark:bg-gray-900 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">Vehicle Servicing & Maintenance</h1>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Expert Vehicle Care</h2>
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 dark:hover:bg-green-500 transition-colors"
                >
                  Book a Service
                </Link>
              </div>
        ...
        <section className="bg-white dark:bg-gray-900 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Our Servicing Options</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-background dark:bg-gray-800 rounded-lg p-8">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Basic Service</h3>
                <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-6">£89</div>
              ...
              <div className="bg-green-600 dark:bg-green-700 rounded-lg p-8 text-white relative">
                <div className="absolute top-4 right-4 bg-white text-green-600 dark:bg-gray-800 dark:text-green-400 px-3 py-1 rounded-full text-sm font-semibold">
                  Popular
                </div>
              ...
              {/* Premium Service */}
              <div className="bg-background dark:bg-gray-800 rounded-lg p-8">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Premium Service</h3>
                <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-6">£249</div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-gray-600 dark:text-gray-400">
                    <svg
                      className="w-5 h-5 text-green-600 dark:text-green-400 mr-3"
