  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                />
                <div className="p-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Vehicle Servicing & Maintenance</h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Pre-Purchase Inspections</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Vehicle Sourcing</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Extended Warranties</h3>
                <p className="text-gray-600 text-sm">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-green-600 rounded-lg px-8 py-12 text-center">
