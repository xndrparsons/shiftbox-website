...
async function getInquiries() {
  ...
  if (isDevelopment && (hasDebugBypass || isMiddlewareDisabled)) {
    console.log("[v0] Using admin debug bypass in inquiries page")
    return []
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">Manage customer contact inquiries and requests</p>
            </div>
