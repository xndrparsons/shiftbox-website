...
async function getVehicles() {
  ...
  // Check authentication in development mode too
  ...
  if (isDevelopment && (hasDebugBypass || isMiddlewareDisabled)) {
    console.log("[v0] Using admin debug bypass in vehicles page - fetching vehicles anyway")
    // Continue to fetch vehicles even in debug mode
  } else {
    const {
      data: { user },
  ...
  console.log("[v0] Fetched vehicles:", vehicles?.length || 0)
  return vehicles || []
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">Manage your vehicle inventory</p>
            </div>
